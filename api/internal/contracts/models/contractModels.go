...
type GetAllContracts struct {
	...
	InitialDate time.Time `json:"date_initial" db:"date_initial"`
}
...
type ContractDatesModel struct {
	ID            int       `json:"id" db:"id"`
	DateInitial   time.Time `json:"date_initial" db:"date_initial"`
	DateLimit     time.Time `json:"date_limit" db:"date_limit"`
	DateGuarantee time.Time `json:"date_guarantee" db:"date_guarantee"`
	DateProposal  time.Time `json:"date_proposal" db:"date_proposal"`
	DateBudget    time.Time `json:"date_budget" db:"date_budget"`
	DateTables    time.Time `json:"date_tables" db:"date_tables"`
}
...
type ContractRhInfoModel struct {
	ID            int       `json:"id" db:"id"`
	HourLimit     time.Time `json:"hour_limit" db:"hour_limit"`
	MinutesLimit  time.Time `json:"minutes_limit" db:"minutes_limit"`
	DaysFirstExp  int       `json:"days_first_exp" db:"days_first_exp"`
	DaysSecondExp int       `json:"days_second_exp" db:"days_second_exp"`
	DataInit      time.Time `json:"data_init" db:"data_init"`
