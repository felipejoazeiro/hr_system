...
func (m *MockDepartmentRepository) EditDepartment(id int, input models.EditDepartmentRequest) (models.DepartmentModel, error) {
	args := m.Called(input)
	return args.Get(0).(models.DepartmentModel), args.Error(1)
}

func (m *MockDepartmentRepository) DeactivateDepartment(id int) error {
	args := m.Called(id)
	return args.Error(0)
}

func (m *MockDepartmentRepository) ReactivateDepartment(id int) error {
	args := m.Called(id)
	return args.Error(0)
}
